...
export const metadata: Metadata = {
  title: "Blog — FreelancePicks",
  description:
    "Expert insights, comparisons, and strategies for choosing and using freelance platforms. Stay informed with the latest in freelance work and remote opportunities.",
};
      ...
      <div className="max-w-[1200px] mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-[#8BA3BE] max-w-2xl mx-auto">
            In-depth reviews of freelancing platforms, invoicing tools, and productivity apps. Expert advice to help you succeed as a freelancer.
          </p>
        </div>
