...
const CATEGORY_DESCRIPTIONS: Record<string, string> = {
  CRM: "Freelance platforms connect independent professionals with clients seeking specific skills and services. Compare the best freelance marketplaces for your career.",
