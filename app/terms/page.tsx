...
export const metadata: Metadata = {
    title: "Terms of Service — FreelanceHubs",
  description:
    "Read the Terms of Service for FreelanceHubs. By using our directory platform, you agree to these terms governing your use of the website and services.",
};
      ...
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-8 text-[#8BA3BE] leading-relaxed">
          <section>
            ...
            <p>
              By accessing or using the FreelanceHubs website (the "Site"), you agree to be
          ...
          <section>
            ...
            <p>
              FreelanceHubs is a curated directory platform that provides information,
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              content — are owned by FreelanceHubs and are protected by international
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              of FreelanceHubs. We reserve the right to moderate, edit, or remove reviews
          ...
          <section>
            ...
            <p>
              ...
              controlled by FreelanceHubs. We have no control over, and assume no
          ...
          <section>
            ...
            <p>
              FreelanceHubs offers free access to our directory and comparison features.
          ...
          <section>
            ...
            <p>
              To the fullest extent permitted by law, FreelanceHubs, its officers, directors,
          ...
          <section>
            ...
            <p>
              You agree to indemnify, defend, and hold harmless FreelanceHubs and its
          ...
          <section>
            ...
            <div className="mt-4 p-5 bg-[#0F1D32] border border-[#1E3A5F] rounded-xl">
              <p className="mb-2"><strong className="text-[#F0F4F8]">Email:</strong> legal@freelancehubs.net</p>
              <p className="mb-2"><strong className="text-[#F0F4F8]">Support:</strong> support@freelancehubs.net</p>
              <p><strong className="text-[#F0F4F8]">Address:</strong> 221B Baker Street, London, UK</p>
            </div>
          </section>
        </div>
      </div>
